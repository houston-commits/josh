  ...
  return (
    <>
        ...
        headline={
          <>
            ...
            <span className="hero-word hero-word--d2">
              <span>Ben Gordon.</span>
            </span>
            <br />
            <span className="hero-word hero-word--d3">
              <span>Seventeen Countries.</span>
            </span>
          </>
        }
        sub={
      ...
      {chapters.map((c, i) => (
        ...
        >
          {i === 0 && <HalftonePattern corner="bottom-right" size={280} opacity={0.3} />}
          {i === chapters.length - 1 && (
            <HalftonePattern corner="top-left" size={280} opacity={0.5} />
          )}
          <div className="wrap">
                ...
                style={{
                  ...
                  background:
                    i % 2 === 0
                      ...
                      : 'linear-gradient(135deg, var(--cream) 0%, #e8e3d4 100%)',
                  position: 'relative',
                  overflow: 'hidden',
                  borderRadius: 4,
                }}
                aria-label={`Chapter ${c.num} placeholder`}
              >
                {/* PLACEHOLDER chapter image */}
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
      ...
      >
        <HalftonePattern corner="top-right" size={260} opacity={0.4} />
        <HalftonePattern corner="bottom-left" size={260} opacity={0.4} />
      ...
      {/* Partnerships */}
      <section className="section-tight surface-ink" style={{ borderTop: '1px solid var(--hairline)' }}>
